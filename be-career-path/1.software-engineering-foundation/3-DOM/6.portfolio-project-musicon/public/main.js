...
//referencing script element with handlebars expressions
const templateElement = document.getElementById('templateHB');

//getting access to the markup inside the previous script and compile it
const templateSource = templateElement.innerHTML;
const template = Handlebars.compile(templateSource);
//adding the contents of context to the template
const compiledHtml = template(context);

//rendering the compiled html
